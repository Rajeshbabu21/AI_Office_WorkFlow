      ...
      <header className="sticky top-0 w-full z-50 bg-[#020308]/85 backdrop-blur-md border-b border-blue-500/10 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a 
              href="#cta" 
              className="text-sm font-semibold bg-gradient-to-r from-blue-600 to-cyan-500 text-white hover:from-blue-500 hover:to-cyan-400 px-5 py-2.5 rounded transition-all duration-300 shadow-[0_0_15px_rgba(59,130,246,0.3)]"
            >
              Get Started
            </a>
          </div>
          ...
          <div className="md:hidden bg-[#020308] border-b border-blue-500/10 px-4 pt-2 pb-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 mt-4">
              ...
              <a 
                href="#cta" 
                onClick={() => setIsMenuOpen(false)}
                className="text-center font-semibold bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-2.5 rounded shadow-[0_0_15px_rgba(59,130,246,0.3)]"
              >
                Get Started
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 border border-blue-500/15 rounded-xl bg-black overflow-hidden font-mono text-xs">
              ...
              <div className="p-5 h-[280px] overflow-y-auto space-y-3 bg-[#020308] text-cyan-400/90 leading-normal scrollbar text-left">
                ...
                {activeAgent === 'resolution' && (
                  <>
                    ...
                    <div className="text-gray-500 bg-gray-950/40 p-2 rounded border border-blue-500/5 my-1">
                ...
                {activeAgent === 'escalation' && (
                  <>
                    ...
                    <div className="text-cyan-400"><span className="text-gray-600">16:34:03.018</span> [CHECK] Similarity score 0.892 &gt; 0.70. Exceeds requirement.</div>
            ...
            <form onSubmit={triggerSandboxSubmit} className="lg:col-span-5 border border-blue-500/20 rounded-xl p-6 bg-black flex flex-col justify-between">
              ...
              <div className="mt-8">
                <button
                  ...
                  className="w-full font-bold bg-gradient-to-r from-blue-600 to-cyan-500 text-white hover:from-blue-500 hover:to-cyan-400 py-3 rounded transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {sandboxLoading ? (
                    <>
